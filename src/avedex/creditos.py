from avedex.src.dados import obter_fontes_globais
from avedex.src.utils import titulo
...
def mostrar_creditos():
    ...
    print("Projeto desenvolvido na disciplina de Boas Práticas de Programação.")
    print()
